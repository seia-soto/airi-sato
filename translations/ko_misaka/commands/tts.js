module.exports = {
  voiceChannelNotFound: '현재 음성 채널에 입장하지 않으셔서 계속하려면 음성 채널에 먼저 입장해주실 것을 미사카는 요청합니다.',
  requestTextNotFound: '재생할 단어 혹은 문장이 주어지지 않았다고 미사카는 자신을 만만하게 보는 듯한 당신을 째려봅니다.',
  requestTextTooLong: '재생할 단어 혹은 문장은 최대 250자라고 말하며 미사카는 그것은 너무 힘든 일이라고 불평합니다.',
